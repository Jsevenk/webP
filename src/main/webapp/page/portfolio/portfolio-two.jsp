               ...
               <div class="container">
                  <div class="row">
                     <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                        <h2 class="title">2 Column Portfolio</h2>
                     </div>
                     <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                     ...
                     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="row">
                           <div class="portfolio two-column">
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 web jquery item">
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 wp css item">
                                 <div class="portfolio-item">
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 php jquery wp item">
                                 <div class="portfolio-item">
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 wp jquery css item">
                                 <div class="portfolio-item">
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 web css wp item">
                                 <div class="portfolio-item">
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 web php item">
                                 <div class="portfolio-item">
