               ...
               <div class="container">
                  <div class="row">
                     <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                        <h2 class="title">Portfolio 4 Column</h2>
                     </div>
                     <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                           ...
                           <div class="portfolio">
                              ...
                              <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 web php item">
                                 <div class="portfolio-item">
                                    ...
                                    <span class="portfolio-item-hover"></span>
                                    <span class="fullscreen"><i class="icon-search"></i></span><img src="img/portfolio/portfolio-6.jpg" alt=" "/>
                                    </a>
                                    <div class="portfolio-item-title">
                                       <a href="single-project.html">Office Meeting</a>
                                       <p>
                                          Meeting / Work
                                       </p>
                                    </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 web jquery item">
                                 <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-item-title">
                                       <a href="single-project.html">Customer Support</a>
                                       <p>
                                          Support / Meeting
                                       </p>
                                    </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 css php wp item">
                                 <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-item-title">
                                       <a href="single-project.html">Camera Buy</a>
                                       <p>
                                          Photo / Device
                                       </p>
                                    </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 web php wp item">
                                 <div class="portfolio-item">
                                    <a href="img/portfolio/portfolio-11.jpg" class="portfolio-item-link" data-rel="prettyPhoto" >
                                    <span class="portfolio-item-hover"></span>
                                    <span class="fullscreen"><i class="icon-search"></i></span><img src="img/portfolio/portfolio-11.jpg" alt=" "/>
                                    </a>
                                    <div class="portfolio-item-title">
                              ...
                              <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 css jquery wp item">
                                 <div class="portfolio-item">
                                    <a href="img/portfolio/portfolio-12.jpg" class="portfolio-item-link" data-rel="prettyPhoto" >
                                    <span class="portfolio-item-hover"></span>
                                    <span class="fullscreen"><i class="icon-search"></i></span><img src="img/portfolio/portfolio-12.jpg" alt=" "/>
                                    </a>
                                    <div class="portfolio-item-title">
                                       <a href="single-project.html">Aperture Point</a>
                                       <p>
                                          Camera / Photo
                                       </p>
                                    </div>
